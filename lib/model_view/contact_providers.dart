...
final nameTECProvider = Provider.autoDispose(
  (ref) => TextEditingController(text: GetStorage().read<String?>('name')),
);

/// no errors if null
/// Phone Error Provider
final phoneErrorProvider = StateProvider.autoDispose<String?>((ref) => null);
final phoneTECProvider = Provider.autoDispose(
  (ref) => TextEditingController(text: GetStorage().read<String?>('phone')),
);

/// no errors if null
/// Email Error Provider
final emailErrorProvider = StateProvider.autoDispose<String?>((ref) => null);
final emailTECProvider = Provider.autoDispose(
  (ref) => TextEditingController(text: GetStorage().read<String?>('email')),
);
